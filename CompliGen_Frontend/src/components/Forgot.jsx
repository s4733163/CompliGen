...
const Forgot = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://127.0.0.1:8000/api/user/reset/', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                // Note: Don't navigate away - user needs to check their email
                // The reset link in email will take them to reset-password page
            } else {
                    ...
                    <div className="auth-branding">
                        <div className="branding-content">
                            ...
                            <div className="branding-features">
                                ...
                                <div className="branding-feature">
                                    <div className="feature-icon">✓</div>
                                    <span>Receive reset link instantly</span>
                                </div>
                                <div className="branding-feature">
                                    <div className="feature-icon">✓</div>
